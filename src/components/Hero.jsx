...
const units = [
  { key: 'd', label: 'DAYS', accent: '#ff4646' },
  { key: 'h', label: 'HRS', accent: '#4f8cff' },
  { key: 'm', label: 'MIN', accent: '#ffc53d' },
  { key: 's', label: 'SEC', accent: '#ff4646' },
];
    ...
    <section id="top" className="relative flex min-h-[100svh] flex-col overflow-hidden">
        ...
        <div className="text-center lg:text-left">
          ...
          >
            <span className="comic-chip bg-[#ffd34d] px-4 py-1.5 text-[11px] text-[#17181f]">
              <span className="h-2 w-2 rounded-full bg-[#ff4646] animate-pulse" />
              DEP-CYS PRESENTS
            </span>
          ...
          <div className="relative inline-block">
            ...
            <span className="font-display absolute -left-6 bottom-2 z-0 text-2xl -rotate-6 text-[#ff4646] wiggle" style={{ animationDelay: '1.5s' }}>
              ★
            </span>
          </div>
          ...
          >
            <span className="font-mono text-[#ff4646]">{EVENT.tagline}</span>
            {' '}— {EVENT.description}
          </motion.p>
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-2 font-mono text-[10px] tracking-[0.2em] text-[#989bb0] lg:justify-start">
            <span className="comic-chip bg-[#2a2412] px-3 py-1 text-[#eef0f6]"><span className="text-[#ff4646]">■</span>{EVENT.duration}</span>
        ...
        >
          <div className="relative mx-auto w-full max-w-md">
            ...
            <div className="comic-card absolute -left-10 top-12 rounded-sm px-5 py-3 float-y" style={{ '--tilt': '-4deg' }}>
              ...
              <div className="font-display text-3xl text-[#ff4646]">3 HRS</div>
            </div>
      ...
      <div className="relative z-10 border-y-[3px] border-[#4a4e60] bg-[#ffd34d] py-4 overflow-hidden">
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 px-5">
          <span className="comic-chip bg-[#ff4646] px-3 py-1 text-[9px] text-[#fffdf6]">FEATURED</span>
          {HERO_DOMAINS.map((d) => (
          ...
          <a href="#domains" className="font-display text-base text-[#4f8cff] hover:text-[#ff4646] transition-colors">+ 10 MORE →</a>
        </div>
      </div>
    </section>
  );
